...
//            catch (Exception parContentEx) { MessageBox.Show("Error in getting paragraph:\nLocalName=" + psection.LocalName + "\n" + parContentEx.Message); }
//        }

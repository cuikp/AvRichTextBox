...
internal static partial class HtmlConversions
{
    ...
    private class InlineFormatting
    {
        ...
        internal FontStyle FontStyle { get; set; } = FontStyle.Normal;
        internal TextDecorationCollection? TextDecorations { get; set; }
        internal BaselineAlignment BaselineAlignment { get; set; } = BaselineAlignment.Baseline;
        internal FontFamily? FontFamily { get; set; }
        internal double? FontSize { get; set; }
        internal SolidColorBrush? Foreground { get; set; }
        internal SolidColorBrush? Background { get; set; }

        internal InlineFormatting Clone()
        {
        ...
        internal void ApplyTo(EditableRun run)
        {

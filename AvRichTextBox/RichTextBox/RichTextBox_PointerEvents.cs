...
public partial class RichTextBox
{
    ...
    private void FlowDocSV_PointerPressed(object? sender, PointerPressedEventArgs e)
    {
        ...
        TextHitTestResult hitCarIndex = currentMouseOverEdPar.TextLayout.HitTestPoint(e.GetPosition(currentMouseOverEdPar));
    ...
    private bool HyperlinkClickable { get; set { field = value; this.Cursor = value ? HyperlinkCursor : CurrentCursor; } }

...
//{
//   public EditableCellBreak(FlowDocument myflowdoc) { Id = ++FlowDocument.InlineIdCounter; MyFlowDoc = myflowdoc; }
   
//    private EditableCellBreak() { }
...
//public class EditableCellBreak : EditableRun
//{
//    public EditableCellBreak() { Id = ++FlowDocument.InlineIdCounter; Text = "\a"; }

//    public override string InlineText => "\a"; // (char)7

//    public override IEditable Clone() => new EditableCellBreak() { MyParagraphId = this.MyParagraphId, MyFlowDoc = this.MyFlowDoc, };

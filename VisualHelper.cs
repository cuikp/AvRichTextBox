...
{
    public static double GetUserY(this Visual? visual)
    {
    ...
    public static Dictionary<EditableParagraph, Rect> GetVisibleEditableParagraphs(this Visual? itemsControl) // where T : Visual
    {
